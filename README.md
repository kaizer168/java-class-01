...
第1个测试计划网络带宽25Mbps, 数据包流量3.8KB，响应时间维持在200ms左右，偶而出现异常，TPS维持在不超过900而不再增加，CPU和内存负载不高，很明显网络带宽到达了瓶颈。我们可以优化接口降低数据量，就有了第2个测试计划网络带宽25Mbps, 数据包流量1.1KB，可以看到TPS提高到1300，CPU和内存资源使用率也上升了. 我们也可以提高网络带宽如第3个测试计划网络带宽100Mbps, 数据包流量3.8KB，TPS也达到了1300，CPU和内存资源使用率也上升了. 如果结合降低接口数据量和提高网络带宽两个优化就会达到更加好的效果。
